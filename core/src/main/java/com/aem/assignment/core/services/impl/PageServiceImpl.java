...
//    MessageGatewayService messageGatewayService;
  ...
  //  @Reference
   // SendNotificationService notificationService;
    ...
    private static final String RECIPIENT_MAIL = "sahankit.0722@gmail.com";
    private static final String SERVICE_USER = "TestUser";


    private static final String PARENT_PAGE_PATH = "/content/aem_assignment/us";

    private static final String PAGE_TEMPLATE = "/conf/aem_assignment/settings/wcm/templates/page-content";
